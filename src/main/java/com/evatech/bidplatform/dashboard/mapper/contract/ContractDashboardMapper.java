...
import com.evatech.bidplatform.dashboard.dto.contract.response.ContractListItemResponse;
import com.evatech.bidplatform.dashboard.dto.contract.response.ContractSummaryResponse;
...
public interface ContractDashboardMapper {
    ...
    default ContractSummaryResponse toSummary(
            List<ContractDocument> contractDocuments,
            String currentUser
    ) {
